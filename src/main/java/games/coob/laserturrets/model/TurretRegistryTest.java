...
public class TurretData extends YamlConfig { // TODO test out turret type

	@Getter
	private static final TurretData instance = new TurretData();
	...
	protected void onSave() {
		...
		this.set("Unplaced_Turrets", this.registeredUnplacedTurrets);
	}
