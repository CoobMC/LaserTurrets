...
public class TurretData implements ConfigSerializable { // TODO create ammo
	...
	public SerializedMap serialize() {
		...
		map.putIf("Unplaced_Turret", this.unplacedTurret);
	...
	public static TurretData deserialize(final SerializedMap map) {
		...
		final ItemStack unplacedTurret = map.getItemStack("Unplaced_Turret");
		...
		turretData.setUnplacedTurret(unplacedTurret);
